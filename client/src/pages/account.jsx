...
const Account = () => {
  ...
  return (
    <div>
      ...
      <div className="mx-44 " ref={componentRef}>
        <div className="flex justify-between">
          ...
          <div><i className="font-bold">bank statement</i></div>
        </div>
        <div className="leading-10 my-16">
          Dear valued customer, We are pleased to provide you with your recent
          bank statement. Please find the statement attached for your records.
          If you have any questions or concerns about your statement, please
          contact us at 555-555-5555 or visit our website at www.yourbank.com.
          Thank you for choosing our bank for your financial needs. Best
          regards, Your Bank.
          <br />
          <br />
          we want to make you know that your ammount is <span className="text-red-500 font-bold">{data.solde}$</span> MR <span className="font-bold">{clientdata.fullname}</span>, thank you
          <br />
          Date :  {year.getDate()+"/"+ year.getMonth()+1+"/"+year.getFullYear()}
        </div>
        <img
          className="w-30 h-20 float-right"
          src="../public/1200px-Autograph_of_Benjamin_Franklin.svg.png"
          alt=""
        />
      </div>
      </div>
        ...
        <div class="p-8 bg-white shadow mt-24">
          ...
          <div class="mt-20 text-center border-b pb-12">
            <h1 class="text-4xl font-medium text-gray-700">
              {clientdata.fullname},{" "}
              <span class="font-light text-gray-500">{data.born_date}</span>
            </h1>
            <p class="font-light text-gray-600 mt-3">
              {data.city}, {data.country}
            </p>
            <p class="mt-8 text-gray-500 font-bold">{clientdata.email}</p>
